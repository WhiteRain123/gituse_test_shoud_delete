...
(function () {
  ...
  function load(config) {
    ...
    if (inArray(includes, "mapbox-gl-enhance")) {
      inputCSS(
        libsurl + "/mapbox-gl-js-enhance/1.12.0-1/mapbox-gl-enhance.css"
      );
      inputScript(
        libsurl + "/mapbox-gl-js-enhance/1.12.0-1/mapbox-gl-enhance.js"
      );
    }
    ...
    if (inArray(includes, "leaflet.markercluster")) {
      inputCSS(
        libsurl +
          "/leaflet/plugins/leaflet.markercluster/1.5.3/MarkerCluster.Default.css"
      );
      inputCSS(
        libsurl +
          "/leaflet/plugins/leaflet.markercluster/1.5.3/MarkerCluster.css"
      );
      inputScript(
        libsurl +
          "/leaflet/plugins/leaflet.markercluster/1.5.3/leaflet.markercluster.js"
      );
    }
    if (inArray(includes, "leaflet.draw")) {
      inputCSS(
        libsurl + "/leaflet/plugins/leaflet.draw/1.0.4/leaflet.draw.css"
      );
      inputScript(
        libsurl + "/leaflet/plugins/leaflet.draw/1.0.4/leaflet.draw.js"
      );
    }
    if (inArray(includes, "leaflet-geoman")) {
      inputCSS(
        libsurl + "/leaflet/plugins/leaflet-geoman/2.14.2/leaflet-geoman.css"
      );
      inputScript(
        libsurl + "/leaflet/plugins/leaflet-geoman/2.14.2/leaflet-geoman.min.js"
      );
    }
    if (inArray(includes, "leaflet.miniMap")) {
      inputCSS(
        libsurl +
          "/leaflet/plugins/leaflet-miniMap/3.6.1/dist/Control.MiniMap.min.css"
      );
      inputScript(
        libsurl +
          "/leaflet/plugins/leaflet-miniMap/3.6.1/dist/Control.MiniMap.min.js"
      );
    }
    ...
    if (inArray(includes, "leaflet.sidebyside")) {
      inputScript(
        libsurl +
          "/leaflet/plugins/leaflet-side-by-side/2.0.1/leaflet-side-by-side.min.js"
      );
    }
    ...
    if (inArray(includes, "d3Layer")) {
      inputScript(
        libsurl + "/leaflet/plugins/leaflet.d3Layer/leaflet-d3Layer.js"
      );
    }
    ...
    if (inArray(includes, "leaflet-icon-pulse")) {
      inputCSS(
        libsurl + "/leaflet/plugins/leaflet-icon-pulse/L.Icon.Pulse.css"
      );
      inputScript(
        libsurl + "/leaflet/plugins/leaflet-icon-pulse/L.Icon.Pulse.js"
      );
    }
    ...
    if (inArray(includes, "pixi")) {
      ...
      inputScript(
        libsurl +
          "/leaflet/plugins/Leaflet.PixiOverlay/1.9.4/L.PixiOverlay.min.js"
      );
      inputScript(
        libsurl + "/leaflet/plugins/Leaflet.PixiOverlay/MarkerContainer.js"
      );
    ...
    if (inArray(includes, "iclient-plot-leaflet")) {
      ...
      if (supportES6()) {
        inputScript(
          libsurl + "/plotting/leaflet/11.1.0/iclient-plot-leaflet-es6.min.js"
        );
      } else {
        inputScript(
          libsurl + "/plotting/leaflet/11.1.0/iclient-plot-leaflet.min.js"
        );
      }
    }
    ...
    if (inArray(includes, "echarts-vue")) {
      ...
      inputScript(
        libsurl + "/echarts-liquidfill/2.0.6/echarts-liquidfill.min.js"
      );
    ...
    if (inArray(includes, "leaflet-mapbox-gl")) {
      inputScript(
        libsurl + "/leaflet-mapbox-gl/0.0.15/leaflet-mapbox-gl.min.js"
      );
    }
  }
